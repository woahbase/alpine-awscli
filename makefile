...
MOUNTFLAGS := -v $(CURDIR)/data:/home/alpine --workdir /home/alpine
...
RUNFLAGS   := -c 256 -m 256m -e PGID=$(PGID) -e PUID=$(PUID) -u alpine
...
test :
	docker run --rm -it $(NAMEFLAGS) $(RUNFLAGS) $(PORTFLAGS) $(OTHERFLAGS) $(IMAGETAG) sh -ec 'python -V; pip -V; aws --version; eb --version; sceptre --version'
